...
class ControlObjectQueue
{
public:
	ControlObjectQueue() : m_lk{ m_mtx }
	{
...
{
public:
	WorkerQueue(ControlObjectQueue* control) : m_PControl{ control }, m_thread{ &WorkerQueue::Run, this }
	{
...
int DoExperimentQueue(bool stacked = false)
{
	const auto chunks = [=]
	{
		if (stacked)
